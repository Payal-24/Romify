...
const archedMirrorOptions = [
  {
    name: "Wooden Frame Arched Mirror",
    image: "/assets/Wooden Frame Arched Mirror1.png",
    price: "₹5,999",
    gallery: [
      "/assets/Wooden Frame Arched Mirror1.png",
      "/assets/Wooden Frame Arched Mirror2.png",
      "/assets/Wooden Frame Arched Mirror3.png"
    ],
    details: [
      { label: "Frame", value: "Wooden" },
      { label: "Style", value: "Arched" },
      { label: "Dimensions", value: "120H x 60W cm" },
      { label: "Feature", value: "Classic Design" },
    ],
  },
  {
    name: "Frameless Arched Mirror",
    image: "/assets/Frameless Arched Mirror1.png",
    price: "₹4,499",
    gallery: [
      "/assets/Frameless Arched Mirror1.png",
      "/assets/Frameless Arched Mirror2.png",
      "/assets/Frameless Arched Mirror3.png"
    ],
    details: [
      { label: "Frame", value: "Frameless" },
      { label: "Style", value: "Arched" },
      { label: "Dimensions", value: "110H x 55W cm" },
      { label: "Feature", value: "Minimalist Look" },
    ],
  },
  {
    name: "Antique Arched Mirror",
    image: "/assets/Antique Arched Mirror1.png",
    price: "₹7,299",
    gallery: [
      "/assets/Antique Arched Mirror1.png",
      "/assets/Antique Arched Mirror2.png",
      "/assets/Antique Arched Mirror3.png"
    ],
    details: [
      { label: "Frame", value: "Antique Finish" },
      { label: "Style", value: "Arched" },
      { label: "Dimensions", value: "130H x 65W cm" },
      { label: "Feature", value: "Vintage Charm" },
    ],
  },
  {
    name: "Double Arch Mirror",
    image: "/assets/Double Arch Mirror1.png",
    price: "₹8,499",
    gallery: [
      "/assets/Double Arch Mirror1.png",
      "/assets/Double Arch Mirror2.png",
      "/assets/Double Arch Mirror3.png"
    ],
    details: [
      { label: "Frame", value: "Wood/Metal" },
      { label: "Style", value: "Double Arch" },
      { label: "Dimensions", value: "140H x 70W cm" },
      { label: "Feature", value: "Unique Shape" },
    ],
  },
];

function ArchedMirrors() {
  ...
  return (
    <>
      ...
      <section className="chairs-page">
        ...
        <h1 className="chairs-title">Arched Mirrors Collection</h1>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 32, alignItems: 'center', justifyContent: 'center' }}>
            {[0, 1].map(rowIdx => (
              <div key={rowIdx} style={{ display: 'flex', gap: 32, justifyContent: 'center' }}>
                {archedMirrorOptions.slice(rowIdx * 2, rowIdx * 2 + 2).map((opt, idx) => (
                  <div
                    key={idx}
        ...
        {selectedMirror && (
          <div style={{
            ...
            <div style={{
              ...
              {show3D && (
                <div style={{
                  ...
                  <div style={{
                    ...
                    <h2 style={{marginBottom: 10, fontFamily: "'Playfair Display', serif", color: '#b86b2a', fontSize: '2rem', letterSpacing: 1}}>3D/AR View: Mirror</h2>
              ...
              <span
                onClick={() => { setSelectedMirror(null); setPreviewImg(null); }}
                style={{
                  position: 'absolute',
                  top: 18,
                  right: 22,
