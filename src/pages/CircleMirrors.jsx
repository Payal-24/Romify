...
const circleMirrorOptions = [
  {
    name: "Round Pivot Mirror",
    image: "/assets/Round Pivot Mirror1.png",
    price: "₹4,499",
    gallery: [
      "/assets/Round Pivot Mirror1.png",
      "/assets/Round Pivot Mirror2.png",
      "/assets/Round Pivot Mirror3.png"
    ],
    details: [
  ...
  {
    name: "Double Round Mirror",
    image: "/assets/Round LED Mirror1.png",
    price: "₹5,999",
    gallery: [
      "/assets/Double Round Mirror1.png",
      "/assets/Double Round Mirror2.png",
      "/assets/Double Round Mirror3.png"
    ],
    details: [
      { label: "Type", value: "Double Round" },
      { label: "Shape", value: "Round" },
      { label: "Material", value: "Glass & Metal" },
      { label: "Feature", value: "Modern Design" },
    ],
  },
  {
    name: "Framed Round Mirror",
    image: "/assets/Framed Round Mirror1.png",
    price: "₹3,999",
    gallery: [
      "/assets/Framed Round Mirror1.png",
      "/assets/Framed Round Mirror2.png",
      "/assets/Framed Round Mirror3.png"
    ],
    details: [
      { label: "Type", value: "Framed" },
      { label: "Shape", value: "Round" },
      { label: "Material", value: "Glass & Wood" },
      { label: "Feature", value: "Classic Frame" },
    ],
  },
  {
    ...
    price: "₹6,499",
    gallery: [
      "/assets/Round LED Mirror1.png",
      "/assets/Round LED Mirror2.png",
      "/assets/Round LED Mirror3.png"
    ],
    details: [
  ...
  return (
    <>
      ...
      <section className="chairs-page">
        ...
        <h1 className="chairs-title">Circle Mirrors Collection</h1>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 32, alignItems: 'center', justifyContent: 'center' }}>
            {[0, 1].map(rowIdx => (
              <div key={rowIdx} style={{ display: 'flex', gap: 32, justifyContent: 'center' }}>
                {circleMirrorOptions.slice(rowIdx * 2, rowIdx * 2 + 2).map((opt, idx) => (
                  <div
                    key={idx}
